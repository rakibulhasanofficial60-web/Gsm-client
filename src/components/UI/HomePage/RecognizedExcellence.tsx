...
const RecognizedExcellence = () => {
    ...
    return (
        <div className="relative bg-gray-900 py-20 px-4 text-white overflow-hidden">
            ...
            <header className="text-center mb-12 relative z-10">
                <h2 className="text-4xl sm:text-5xl font-extrabold tracking-wider mb-3 uppercase">
                   Recognized excellence
                </h2>
                <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                   Experience the credibility of Coach Kanchon's impressive awards and industry recognitions
                </p>
            </header>
